    ...
    <div class="card card-custom m-3">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @if($datas->count() < 1)
                <!--begin::Button-->
                <a href="{{route('profils.create', ['slug' => $slug, 'uuid' => $uuid])}}" class="btn btn-primary font-weight-bolder">
                        ...
                        @forelse($datas as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('profils.destroy', ['slug' => $slug, 'uuid' => $uuid, 'uuid_item' => $item->uuid])}}" class="badge badge-sm badge-danger m-2" onclick="return confirm('Apakah Anda Yakin Menghapus Data ini ?')">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
