...
@section('content')
    ...
    <div class="card card-custom m-3">
        ...
        <div class="card-body">
            <div class="col-12">
                <form class="form" action="{{route('dokumens.store', ['slug' => $slug, 'uuid' => $uuid])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-12">
                        ...
                        <input class="form-control  @error('file') is-invalid @enderror" name="file" type="file" id="formFile" accept="application/pdf" required>
                        <span class="form-text text-muted">File harus bertipe PDF dengan ukuran maksimal 20480kb</span>
                        @error('file')
                            <span class="form-text text-danger">{{$message}}</span>
                        @enderror
                    </div>
