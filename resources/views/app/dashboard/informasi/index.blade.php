    ...
    <div class="card card-custom m-3">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('postingans.create', ['slug' => $slug, 'uuid' => $uuid])}}" class="btn btn-primary font-weight-bolder">
                    ...
                    <tbody>
                        @forelse($datas as $item)
                            <tr>
                                <td>
                                    @if($item->is_headline)
                                        <span class="badge badge-sm badge-primary">Headline</span>
                                        <br/>
                                    @endif
                                    {{$item->judul}}
                                    <br/>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('postingans.destroy', ['slug' => $slug, 'uuid' => $uuid, 'uuid_item' => $item->uuid])}}" class="badge badge-sm badge-danger m-2" onclick="return confirm('Apakah Anda Yakin Menghapus Data ini ?')">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
