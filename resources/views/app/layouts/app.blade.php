...
<head>
    <base href="../../">
    <meta charset="utf-8" />
    <title>Admin | Sistem Informasi</title>
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{ asset('logo.png') }}" height="30px;" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="flex-row d-flex flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="/" class="brand-logo">
                        <img alt="Logo" src="{{ asset('logo.png') }}" height="40" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                <!--begin::Header-->
                @include('app.layouts.headermenu')
                <!--end::Header-->
                <!--begin::Content-->
        ...
        <div class="pr-5 offcanvas-content mr-n5">
            ...
            <div class="mt-5 d-flex align-items-center">
                ...
                <div class="d-flex flex-column">
                    <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ auth()->user()->nama_lengkap }}</a>
                    <div class="mt-1 text-muted">{{str_replace('_', ' ', auth()->user()->role->nama)}}</div>
                    <div class="mt-2 navi">
                        <a href="{{url('/logout')}}" class="px-5 py-2 btn btn-sm btn-light-primary font-weight-bolder">Sign Out</a>
                    </div>
                </div>
            </div>
            <!--end::Header-->
            ...
            <div>
                ...
                {{-- <div class="p-5 rounded d-flex align-items-center bg-light-warning gutter-b">
                    ...
                    <div class="mr-2 d-flex flex-column flex-grow-1">
                        <a href="#" class="mb-1 font-weight-normal text-dark-75 text-hover-primary font-size-lg">Another
                            purpose persuade</a>
                ...
                <div class="p-5 rounded d-flex align-items-center bg-light-success gutter-b">
                    ...
                    <div class="mr-2 d-flex flex-column flex-grow-1">
                        <a href="#" class="mb-1 font-weight-normal text-dark-75 text-hover-primary font-size-lg">Would
                            be to people</a>
                        <span class="text-muted font-size-sm">Due in 2 Days</span>
                    </div>
                    ...
                    <div class="mr-2 d-flex flex-column flex-grow-1">
                        <a href="#" class="mb-1 font-weight-normel text-dark-75 text-hover-primary font-size-lg">Purpose
                    ...
                    <div class="mr-2 d-flex flex-column flex-grow-1">
                        <a href="#" class="mb-1 font-weight-normel text-dark-75 text-hover-primary font-size-lg">The
                            best product</a>
                        <span class="text-muted font-size-sm">Due in 2 Days</span>
                    </div>
    ...
    <!-- end::User Panel-->
    <!--begin::Quick Cart-->
    <div id="kt_quick_cart" class="p-10 offcanvas offcanvas-right">
        <!--begin::Header-->
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="m-0 font-weight-bold">Shopping Cart</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <div class="mb-5 offcanvas-wrapper scroll-pull">
                <!--begin::Item-->
                <div class="py-8 d-flex align-items-center justify-content-between">
                    <div class="mr-2 d-flex flex-column">
                        <a href="#" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">iBlender</a>
                        <span class="text-muted">The best kitchen gadget in 2020</span>
                        <div class="mt-2 d-flex align-items-center">
                            <span class="mr-1 font-weight-bold text-dark-75 font-size-lg">$ 350</span>
                            <span class="mr-1 text-muted">for</span>
                            <span class="mr-2 font-weight-bold text-dark-75 font-size-lg">5</span>
                            <a href="#" class="mr-2 btn btn-xs btn-light-success btn-icon">
                    ...
                    <a href="#" class="flex-shrink-0 symbol symbol-70">
                ...
                <div class="py-8 d-flex align-items-center justify-content-between">
                    <div class="mr-2 d-flex flex-column">
                        ...
                        <div class="mt-2 d-flex align-items-center">
                            <span class="mr-1 font-weight-bold text-dark-75 font-size-lg">$ 650</span>
                            <span class="mr-1 text-muted">for</span>
                            <span class="mr-2 font-weight-bold text-dark-75 font-size-lg">4</span>
                            <a href="#" class="mr-2 btn btn-xs btn-light-success btn-icon">
                                <i class="ki ki-minus icon-xs"></i>
                            </a>
                            <a href="#" class="btn btn-xs btn-light-success btn-icon">
                ...
                <div class="py-8 d-flex align-items-center justify-content-between">
                    <div class="mr-2 d-flex flex-column">
                        ...
                        <div class="mt-2 d-flex align-items-center">
                            <span class="mr-1 font-weight-bold text-dark-75 font-size-lg">$ 150</span>
                            <span class="mr-1 text-muted">for</span>
                            <span class="mr-2 font-weight-bold text-dark-75 font-size-lg">3</span>
                            <a href="#" class="mr-2 btn btn-xs btn-light-success btn-icon">
                                <i class="ki ki-minus icon-xs"></i>
                            </a>
                            <a href="#" class="btn btn-xs btn-light-success btn-icon">
                ...
                <div class="py-8 d-flex align-items-center justify-content-between">
                    <div class="mr-2 d-flex flex-column">
                        ...
                        <div class="mt-2 d-flex align-items-center">
                            <span class="mr-1 font-weight-bold text-dark-75 font-size-lg">$ 1450</span>
                            <span class="mr-1 text-muted">for</span>
                            <span class="mr-2 font-weight-bold text-dark-75 font-size-lg">7</span>
                            <a href="#" class="mr-2 btn btn-xs btn-light-success btn-icon">
                                <i class="ki ki-minus icon-xs"></i>
                            </a>
                            <a href="#" class="btn btn-xs btn-light-success btn-icon">
            ...
            <div class="offcanvas-footer">
                <div class="mb-4 d-flex align-items-center justify-content-between">
                    <span class="mr-2 font-weight-bold text-muted font-size-sm">Total</span>
                    <span class="text-right font-weight-bolder text-dark-50">$1840.00</span>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-7">
                    <span class="mr-2 font-weight-bold text-muted font-size-sm">Sub total</span>
                    <span class="text-right font-weight-bolder text-primary">$5640.00</span>
                </div>
                                ...
                                <div class="mb-5 d-flex flex-column align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3 symbol symbol-circle symbol-40">
                                            <img alt="Pic"
                                                src="{{ asset('admin') }}/assets/media/users/300_12.jpg" />
                                        </div>
                                        <div>
                                            <a href="#"
                                ...
                                <div class="mb-5 d-flex flex-column align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-3 symbol symbol-circle symbol-40">
                                            <img alt="Pic"
                                                src="{{ asset('admin') }}/assets/media/users/300_21.jpg" />
                                        </div>
                                    </div>
                                    <div
